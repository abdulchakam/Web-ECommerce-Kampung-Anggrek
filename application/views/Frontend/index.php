...
<h5 class="">Produk Terlaris</h5>
<hr>
    <div class="row ">
		<?php foreach ($produks2 as $produk) { ?>
			<div class="col-lg-3 col-md-4 col-sm-5 mb-3 ">
				<a href="<?php echo site_url('produk/detail/').$produk->kd_brg ?>" style="text-decoration:none">
					<div class="card-style">
						...
						<span class="badge badge-info align-baseline mx-3 my-2">Terjual : <?php echo $produk->qty ?> </span>
						<br>
