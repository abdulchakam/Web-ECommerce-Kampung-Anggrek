          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="card-body">
							...
							<div class="form-group">
									<label for="fid">Id User*</label>
									<input class="form-control <?php echo form_error('fid') ? 'is-invalid':'' ?>"
									type="text" name="fid" placeholder="Id user" value="<?php echo $user->id ?>" readonly  />
									<div class="invalid-feedback">
										<?php echo form_error('fid') ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									type="text" name="fusername" placeholder="Username" value="<?php echo $user->username ?>" required  />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="email" name="femail" placeholder="Email " value="<?php echo $user->email ?>" required  />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									<label for="fpassword">Password lama/baru</label>
